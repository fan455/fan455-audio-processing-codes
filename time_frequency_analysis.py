...
def stft(au, sr, channel=0, output='m, p', nperseg=None, noverlap=0):
    """
    Parameters:
    ...
    output: str. 'm, p' will return two magnitudes and phases arrays. 'complex' will return a complex array as normal. 'r, i' will return two real and imaginary arrays derived from the complex array.
